...
class EmployeeRegistrationForm(UserCreationForm):
    ...
    def clean_email(self):
        ...
        if not email.lower().endswith(("@gmail.com", "@emial.com")):
            raise forms.ValidationError("Email should end with @gmail.com or @emial.com")
        return email
...
class EmployerRegistrationForm(UserCreationForm):
    ...
    def clean_email(self):
        email = self.cleaned_data.get('email')
        if email and not (email.endswith('@gmail.com') or email.endswith('@email.com')):
            raise forms.ValidationError('Email must end with @gmail.com or @email.com')
        return email
